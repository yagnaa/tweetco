...
public class RoundedImageView extends RecyclingImageView {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		hasBorder = attributes.getBoolean(R.styleable.RoundedImageView_border, false);
		hasSelector = attributes.getBoolean(R.styleable.RoundedImageView_selector, false);
		...
		if(hasSelector) {
			...
			setSelectorColor(attributes.getColor(R.styleable.RoundedImageView_selector_color, Color.TRANSPARENT));
			setSelectorStrokeWidth(attributes.getDimensionPixelOffset(R.styleable.RoundedImageView_selector_stroke_width, defaultSelectorSize));
			setSelectorStrokeColor(attributes.getColor(R.styleable.RoundedImageView_selector_stroke_color, Color.BLUE));
		}
